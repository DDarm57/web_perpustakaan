...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/">
                ...
                <div class="sidebar-brand-text mx-3">Perpus <sup>smp</sup></div>
            </a>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <img class="img-profile rounded-circle" src="/assets/img/admin/<?= session()->get('user_image'); ?>">
                            </a>
    ...
    <script>
        function previewImg() {
            const inpGambar = document.querySelector('#gambar');
            const gambarLabel = document.querySelector('.custom-file-label');
            const imgPreview = document.querySelector('.img-preview');

            gambarLabel.textContent = inpGambar.files[0].name;

            const fileGambar = new FileReader();
            fileGambar.readAsDataURL(inpGambar.files[0]);
    ...
    <script>
        ...
        $(document).ready(function() {
            $("#centangSemuaBuku").click(function(e) {
                if ($(this).is(':checked')) {
                    $(".centangIdbuku").prop('checked', true);
                } else {
                    $(".centangIdbuku").prop('checked', false);
                }
            });
        });

        $(document).ready(function() {
            $("#centangSemuaSiswa").click(function(e) {
                if ($(this).is(':checked')) {
                    $(".centangIdsiswa").prop('checked', true);
                } else {
                    $(".centangIdsiswa").prop('checked', false);
                }
            });
        });
    </script>
